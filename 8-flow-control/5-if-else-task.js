// We should restrict user enter only Green,Red,Yellow;
...
// const userInput =
// readline.question(`select any one option for current light
// 1. Green
// 2. Red
// 3. Yellow
// `);
...
const colorIndex =
readline.keyInSelect(COLOR_OPTION);

console.log(`User Input value ${colorIndex} =
${COLOR_OPTION[colorIndex]}`);
