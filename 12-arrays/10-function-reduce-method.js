...
console.log(`Sum of numbers using FOR LOOP`, total);
...
// const totalMarksOfStudents = [
    ...
    console.log("------------------")
    console.log("Avarage Marks of Students")
    console.log("------------------")

    const averageMarks = totalMarks.map((value) => (value / 600) * 100);
    console.log(averageMarks)

    const converToInteger = averageMarks.map(value => parseInt(value) + "%");
    console.log(converToInteger);
